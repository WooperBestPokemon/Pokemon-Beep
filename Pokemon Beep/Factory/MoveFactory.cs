...
namespace Pokemon_Beep.Factory
{
    class MoveFactory
    {
        public List<Move> GetMoves()
        {
            ...
            moves.Add(new Move("Cut", 65, 100, 30, (int)Enum.type.Grass, "Physical", "The foe is cut with a scythe or a claw. It can also be used to cut down thin trees."));
            moves.Add(new Move("Dragon Claw", 80, 100, 15, (int)Enum.type.Dragon, "Physical", "The user slashes the foe with huge, sharp claws."));
            moves.Add(new Move("Dragon Pulse", 85, 100, 10, (int)Enum.type.Dragon, "Special", "The foe is attacked with a shock wave generated by the user's gaping mouth."));
            moves.Add(new Move("Drill Peck", 80, 100, 20, (int)Enum.type.Fly, "Physical", "A corkscrewing attack with the sharp beak acting as a drill."));
            moves.Add(new Move("Egg Bomb", 100, 75, 10, (int)Enum.type.Normal, "Physical", "A large egg is hurled with maximum force at the foe to inflict damage."));
            moves.Add(new Move("Fairy Wind", 40, 100, 30, (int)Enum.type.Fairy, "Special", "The user stirs up a fairy wind and strikes the target with it."));
            moves.Add(new Move("Horn Attack", 65, 100, 25, (int)Enum.type.Normal, "Physical", "The foe is jabbed with a sharply pointed horn to inflict damage."));
            moves.Add(new Move("Hydro Pump", 110, 80, 5, (int)Enum.type.Water, "Special", "The foe is blasted by a huge volume of water launched under great pressure."));
            moves.Add(new Move("Hyper Voice", 90, 100, 10, (int)Enum.type.Normal, "Special", "The user lets loose a horribly echoing shout with the power to inflict damage."));
            moves.Add(new Move("Mega Kick", 120, 75, 5, (int)Enum.type.Normal, "Physical", "The foe is attacked by a kick launched with muscle-packed power."));
            moves.Add(new Move("Mega Punch", 80, 85, 20, (int)Enum.type.Normal, "Physical", "The foe is slugged by a punch thrown with muscle-packed power."));
            moves.Add(new Move("Megahorn", 120, 85, 10, (int)Enum.type.Bug, "Physical", "Utilizing its tough and impressive horn, the user rams into the foe with no letup."));
            moves.Add(new Move("Peck", 35, 100, 35, (int)Enum.type.Fly, "Physical", "The foe is jabbed with a sharply pointed beak or horn."));
            moves.Add(new Move("Pound", 40, 100, 35, (int)Enum.type.Normal, "Physical", "The foe is physically pounded with a long tail or a foreleg, etc."));
            moves.Add(new Move("Power Gem", 80, 100, 20, (int)Enum.type.Rock, "Special", "The user attacks with a ray of light that sparkles as if it were made of gemstones."));
            moves.Add(new Move("Power Whip", 120, 85, 10, (int)Enum.type.Grass, "Physical", "The user violently whirls its vines or tentacles to harshly lash the foe."));
            moves.Add(new Move("Rock Throw", 50, 90, 15, (int)Enum.type.Rock, "Physical", "The user picks up and throws a small rock at the foe to attack."));
            moves.Add(new Move("Scratch", 40, 100, 35, (int)Enum.type.Normal, "Physical", "Hard, pointed, and sharp claws rake the foe to inflict damage."));
            moves.Add(new Move("Seed Bomb", 80, 100, 15, (int)Enum.type.Grass, "Physical", "The user slams a barrage of hard-shelled seeds down on the foe from above."));
            moves.Add(new Move("Slam", 80, 75, 20, (int)Enum.type.Normal, "Physical", "The foe is slammed with a long tail, vines, etc., to inflict damage."));
            moves.Add(new Move("Strength", 80, 100, 15, (int)Enum.type.Fighting, "Physical", "The foe is slugged with a punch thrown at maximum power."));
            moves.Add(new Move("Tackle", 40, 100, 35, (int)Enum.type.Normal, "Physical", "A physical attack in which the user charges and slams into the foe with its whole body."));
            moves.Add(new Move("Vine Whip", 45, 100, 25, (int)Enum.type.Grass, "Physical", "The foe is struck with slender, whiplike vines to inflict damage."));
            moves.Add(new Move("Water Gun", 40, 100, 25, (int)Enum.type.Water, "Special", "The foe is blasted with a forceful shot of water."));
            moves.Add(new Move("Wing Attack", 60, 100, 35, (int)Enum.type.Fly, "Physical", "The foe is struck with large, imposing wings spread wide to inflict damage."));
            ...
            moves.Add(new Move("Aerial Ace", 60, 1600, 20, (int)Enum.type.Fly, "Physical", "The user confounds the foe with speed, then slashes. The attack lands without fail."));
            moves.Add(new Move("Aura Sphere", 80, 1600, 20, (int)Enum.type.Fighting, "Special", "The user looses a blast of aura power from deep within its body. This move is certain to hit."));
            moves.Add(new Move("Disarming Voice", 40, 1600, 15, (int)Enum.type.Fairy, "Special", "Letting out a charming cry, the user does emotional damage to opposing Pokémon. This attack never misses."));
            moves.Add(new Move("Feint Attack", 60, 1600, 20, (int)Enum.type.Dark, "Physical", "The user draws up to the foe disarmingly, then throws a sucker punch. It hits without fail."));
            moves.Add(new Move("Magical Leaf", 60, 1600, 20, (int)Enum.type.Grass, "Special", "The user scatters curious leaves that chase the foe. This attack will not miss."));
            moves.Add(new Move("Magnet Bomb", 60, 1600, 20, (int)Enum.type.Steel, "Physical", "The user launches a steel bomb that sticks to the target. This attack will not miss."));
            moves.Add(new Move("Shadow Punch", 60, 1600, 20, (int)Enum.type.Ghost, "Physical", "The user throws a punch at the foe from the shadows. The punch lands without fail."));
            moves.Add(new Move("Shock Wave", 60, 1600, 20, (int)Enum.type.Electric, "Special", "The user strikes the foe with a quick jolt of electricity. This attack cannot be evaded."));
            moves.Add(new Move("Swift", 60, 1600, 20, (int)Enum.type.Normal, "Special", "Star-shaped rays are shot at the foe. This attack never misses."));
            moves.Add(new Move("Vital Throw", 70, 1600, 10, (int)Enum.type.Fighting, "Physical", -1, "The user allows the foe to attack first. In return, this throw move is guaranteed not to miss."));
